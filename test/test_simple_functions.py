...
class MemcachedTests(unittest.TestCase):
    ...
    def testSetMultiBigData(self):
        self.client.set_multi({str(k): b"value" for k in range(32767)})
    ...
    def testGetMulti(self):
        ...
        self.assertEqual(
            {"test_key": "value", "test_key2": "value2"}, self.client.get_multi(["test_key", "test_key2", "nothere"])
        )
    ...
    def testDeleteMulti(self):
        self.client.set_multi({"test_key": "value", "test_key2": "value2"})
...
class TimeoutMemcachedTests(unittest.TestCase):
    ...
    def tearDown(self):
        if self.client:
            self.client.disconnect_all()
        client = bmemcached.Client(self.server, "user", "password", socket_timeout=None)
        client.delete("timeout_key")
        client.delete("timeout_key_none")
        client.disconnect_all()

    def testTimeout(self):
        self.client = bmemcached.Client(self.server, "user", "password", socket_timeout=0.00000000000001)
    ...
    def testTimeoutNone(self):
        self.client = bmemcached.Client(self.server, "user", "password", socket_timeout=None)
...
class BinaryMemcachedTests(unittest.TestCase):
    ...
    def testSetMulti(self):
        self.assertCountEqual(
            self.client.set_multi({self.bkey(): "value", self.skey(): "value2", self.bkey(): "value3"}), []
        )

    def testSetMultiBigData(self):
        self.client.set_multi({self.bkey(): b"value" for _ in range(32767)})
        self.client.set_multi({self.skey(): b"value" for _ in range(32767)})
    ...
    def testGetMulti(self):
        ...
        test_key4 = self.skey()
        self.assertCountEqual(
            self.client.set_multi({test_key1: "value", test_key2: "value2", test_key3: "value3", test_key4: "value4"}),
            [],
        )
        self.assertEqual(
            {test_key1: "value", test_key2: "value2", test_key3: "value3"},
            self.client.get_multi([test_key1, test_key2, test_key3]),
        )
        self.assertEqual(
            {test_key1: "value", test_key2: "value2", test_key3: "value3", test_key4: "value4"},
            self.client.get_multi([test_key1, test_key2, test_key3, test_key4]),
        )
        self.assertEqual(
            {test_key1: "value", test_key2: "value2"}, self.client.get_multi([test_key1, test_key2, "nothere"])
        )
    ...
    def testDeleteMulti(self):
        test_key1 = self.bkey()
        test_key2 = self.bkey()
        self.client.set_multi({test_key1: "value", test_key2: "value2"})
